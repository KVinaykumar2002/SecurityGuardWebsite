...
const LoginPage: React.FC<LoginPageProps> = ({ setPage, onLoginSuccess }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (email === 'admin@shield.com' && password === 'password123') {
            ...
            <div className="relative z-10 w-full max-w-md">
                <AnimatedSection>
                    <div className="bg-glass-bg backdrop-blur-xl border border-white/10 rounded-lg p-8 shadow-2xl shadow-black/30">
                        ...
                        <p className="text-center text-gray-400 mb-6">Login to access your dashboard.</p>
                        ...
                        <p className="text-center text-gray-500 text-xs mt-6">
                            Hint: Use <strong>admin@shield.com</strong> and <strong>password123</strong>
                        </p>
